<template>
  <b-section id="realEstateIntro" class="hero-section moving section-padding">
    <div class="relative h-auto">
      <showcase />
      <img :src="item.image_url" :alt="item.name" class="w-full" />

      <div class="fixed bottom-0 z-[2000] bg-[#0D1527]/70 py-20 text-center md:mx-auto md:w-full">
        <div class="">
          <h2
        ...
        <div class="absolute bottom-40 z-10 w-full">
          <router-link
            :to="{ route: 'realEstate' }"
...
import Showcase from '@/scenes/real-estate/__Showcase.vue';
